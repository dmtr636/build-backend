...
import com.kydas.build.auth.login.LoginAttempt;
import com.kydas.build.auth.login.LoginAttemptRepository;
...
import com.kydas.build.core.exceptions.handler.ExceptionResponse;
...
import static com.kydas.build.AssertUtils.assertException;
import static com.kydas.build.AssertUtils.assertGoodRequest;
import static com.kydas.build.auth.AuthTestUnits.getLoginRequest;
import static com.kydas.build.auth.login.LoginAttemptService.*;
...
class AuthControllerTest {
    ...
    void successfulLogout() {
        var response = restTemplate.postForEntity(
            Endpoints.AUTH_ENDPOINT + "/logout",
            null,
            Void.class
        );
        assertGoodRequest(response);
